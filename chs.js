...
var cnPrefix = {
    ...
    "Offer target: ": "报价目标: ",
    "RG -": "重启目标 -",
    "Decrease Restart Goal by ": "将重启目标降低 ",
    "Increase per unit power by ": "单位战力提升 ",
    "Each tree reduces Restart Goal by ": "每棵树使重启目标降低 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^Each tree reduces RG by (.+) \| A purple tree represents (.+) units$/, '每棵树减少 $1 的重启目标 \| 紫色树代表 $2 个单位'],
	[/^([\d\.]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+)\/sec$/, '$1\/秒'],
	[/^([\d\.,]+) OOMs\/sec$/, '$1 OOMs\/秒'],
	[/^([\d\.]+) OOMs\/sec$/, '$1 OOMs\/秒'],
